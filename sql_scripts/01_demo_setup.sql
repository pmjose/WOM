...
-- Create Git repository integration for the WOM Peru demo repository
...
CREATE OR REPLACE SEMANTIC VIEW WOM_SALES_SEMANTIC_VIEW
    ...
    COMMENT = 'Sales semantic view for WOM Peru';
...
CREATE OR REPLACE SEMANTIC VIEW WOM_MARKETING_SEMANTIC_VIEW
    ...
    COMMENT = 'Marketing semantic view for WOM Peru';
...
CREATE OR REPLACE SEMANTIC VIEW WOM_HR_SEMANTIC_VIEW
    ...
    COMMENT = 'HR semantic view for WOM Peru';
